 ...
 * @author Ethan Mirado
 */
public class PublicationsForTimelineNotif extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<DetPublication> listdetpubno = mobi.vraiPublication(iduser, longitude, latitude);
        ...
        for (DetPublication ldp : listdetpubno) {
            try {
                obj = new JSONObject();
                obj.put("confidentialite", ldp.getConfidentialite());
                obj.put("contenupublication", ldp.getContenupublication());
